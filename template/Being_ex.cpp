...
int main()
{
    Person<int, double, double> hchao("Hongchao-o", 26, 1.78, 78.2, "Li");
    Person<int, double, double> * Hongchao = &hchao;
    //hchao.hello();
    //Hongchao->hello();

    const int SIZE = 3;
    Person<int, double, double> *arr[SIZE] = {
        new Person<int, double, double> ("Hongchao-o", 26, 1.78, 78.2, "Li"),
        new Person<int, double, double> ("George", 29, 1.70, 89.5, "Li"),
        new Person<int, double, double> ("Andrew", 56, 1.74, 88.4, "Li")
    };
